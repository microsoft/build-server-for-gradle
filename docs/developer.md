...
1. We utilize the `BuildAction` to capture the complete hierarchical scope of the project, allowing us to retrieve all
   the included builds and their associated information.
...
3. We finally traverse through the list of JDKs retrieved from the preferences, and try to find a
   compatible `JAVA_HOME`.
